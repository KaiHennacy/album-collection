...
let levels = 5; // How many contrast steps away from the base color do you want mapped? (applies to both tints and shades)
...
baseColorsMap.set("primary", "#130303");
baseColorsMap.set("secondary", "#2d080a");
baseColorsMap.set("tertiary", "#7c3626");
baseColorsMap.set("emphasis", "#f5853f");
baseColorsMap.set("text-default", "#ffcdbc");
